...
namespace MyFoodApp.API.Migrations
{
    ...
    [Migration("20201003014437_Change_ExceptionDate_Optional")]
    partial class Change_ExceptionDate_Optional
    {
            ...
            modelBuilder.Entity("MyFoodApp.API.Entities.Event", b =>
                {
                    ...
                    b.HasOne("MyFoodApp.API.Entities.Location", "DestinationLocation")
                        .WithOne("Event")
                        .HasForeignKey("MyFoodApp.API.Entities.Event", "DestinationLocationId");
