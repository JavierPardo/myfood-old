...
namespace MyFoodApp.API.Migrations
{
    ...
    [Migration("20200622041758_Add_InitialData")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MyFoodApp.API.Entities.ClientsGroups", b =>
                {
                    b.Property<int>("ClientId")
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("MyFoodApp.API.Entities.ClientsUsers", b =>
                {
                    b.Property<int>("ClientId")
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("MyFoodApp.API.Entities.OptionPriceHistory", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("MyFoodApp.API.Entities.OrderItems", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("MyFoodApp.API.Entities.Transaction", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("MyFoodApp.API.Entities.TransactionType", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("MyFoodApp.API.Entities.Invoice", b =>
                {
                    b.HasOne("MyFoodApp.API.Entities.Transaction", "Transaction")
                        .WithOne("Invoice")
            ...
            modelBuilder.Entity("MyFoodApp.API.Entities.Transaction", b =>
                {
                    ...
                    b.HasOne("MyFoodApp.API.Entities.TransactionType", "TransactionType")
                        .WithMany("Transactions")
                        .HasForeignKey("TypeId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
