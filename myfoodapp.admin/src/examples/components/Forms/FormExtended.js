        ...
        <Card className="card-default">
          ...
          <CardBody>
            <form method="get" action="#" className="form-horizontal">
                      ...
                      <Col xs={12}>
                        ...
                        {this.state.displayColorPickerInput ? (
                          <div style={popover}>
                            <div
                              style={cover}
                              onClick={this.colorpickerInputHandleClose}
                            />
                            <SketchPicker
                ...
                <div className="form-group row">
                  ...
                  <Col md={10}>
                    ...
                    <div className="text-sm text-muted">
                      ...
                      <code>\</code> to use them as static contents
                    </div>
              ...
              <fieldset>
                <div className="form-group row mb">
                  <label className="col-md-2 col-form-label mb">
                    DateTimePicker
                  </label>
                  <Col md={10}>
                    <p>Basic</p>
                ...
                <div className="form-group row">
                  ...
                  <Col md={10}>
                    <Card body>
                      <textarea
                        rows="10"
                        className="form-control note-editor"
                      ></textarea>
                    </Card>
                    <p>With margin</p>
                    <Card body>
