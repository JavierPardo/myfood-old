                ...
                <div className="col-auto">
                  <div className="checkbox c-checkbox">
                    <label className="mb-1">
                      <Input type="checkbox" />
                      <span className="fa fa-check"></span>Remember
                    </label>
                  </div>
                </div>
                <div className="col-auto">
              ...
              <fieldset>
                <FormGroup row>
                  ...
                  <div className="col-md-10">
                    ...
                    <FormGroup check inline>
                      <Label check>
                        <Input type="radio" name="inlineradio" /> Some other
                        input
                      </Label>
                    </FormGroup>
                  </div>
                  ...
                  <div className="col-md-10">
                    <div className="checkbox c-checkbox">
                      <label>
                        ...
                        <span className="fa fa-check"></span>Option one
                      </label>
                    </div>
                    <div className="checkbox c-checkbox">
                      <label>
                        <Input
                          ...
                          defaultValue=""
                        />
                        <span className="fa fa-check"></span>Option two
                        defaultChecke
                      </label>
                    </div>
                    <div className="checkbox c-checkbox">
                      <label>
                        <Input
                          ...
                          defaultValue=""
                        />
                        <span className="fa fa-check"></span>Option three
                        defaultChecke and disabled
                      </label>
                    </div>
                    <div className="checkbox c-checkbox">
                      <label>
                        <Input type="checkbox" disabled="" defaultValue="" />
                        <span className="fa fa-check"></span>Option four
                        disabled
                      </label>
                    </div>
                    <div className="c-radio">
                      <label>
                        ...
                        <span className="fa fa-circle"></span>Option one
                      </label>
                    </div>
                    <div className="c-radio">
                      <label>
                        <Input
                          ...
                          defaultChecked=""
                        />
                        <span className="fa fa-circle"></span>Option two
                        defaultChecke
                      </label>
                    </div>
                    <div className="c-radio">
                      <label>
                        <Input
                          ...
                          disabled=""
                        />
                        <span className="fa fa-circle"></span>Option three
                        defaultChecke and disabled
                      </label>
                    </div>
                    <div className="c-radio">
                      <label>
                        ...
                        <span className="fa fa-circle"></span>Option four
                        disabled
                      </label>
                    </div>
                  </div>
                ...
                <FormGroup row>
                  ...
                  <div className="col-md-10">
                    <label className="c-checkbox">
                      ...
                      />
                      <span className="fa fa-check"></span>a
                    </label>
                    <label className="c-checkbox">
                      <Input
                        id="inlineCheckbox20"
                        ...
                        defaultValue="option2"
                      />
                      <span className="fa fa-check"></span>b
                    </label>
                    <label className="c-checkbox">
                      <Input
                        id="inlineCheckbox30"
                      ...
                      />
                      <span className="fa fa-check"></span>c
                    </label>
                  </div>
                </FormGroup>
              </fieldset>
                  ...
                  <div className="col-md-10">
                    <label className="checkbox c-checkbox c-checkbox-rounded">
                      <Input
                        ...
                        defaultChecked
                      />
                      <span className="fa fa-check"></span>Lorem
                    </label>
                    <label className="checkbox c-checkbox c-checkbox-rounded">
                      <Input id="roundedcheckbox20" type="checkbox" />
                      <span className="fa fa-check"></span>Ipsum
                    </label>
                  </div>
                </FormGroup>
              </fieldset>
                  ...
                  <div className="col-md-10">
                    <label className="c-radio">
                      <Input
                        ...
                        defaultChecked
                      />
                      <span className="fa fa-circle"></span>a
                    </label>
                    <label className="c-radio">
                      <Input
                        id="inlineradio2"
                        ...
                        defaultValue="option2"
                      />
                      <span className="fa fa-circle"></span>b
                    </label>
                    <label className="c-radio">
                      <Input
                        id="inlineradio3"
                        ...
                        defaultValue="option3"
                      />
                      <span className="fa fa-circle"></span>c
                    </label>
                  </div>
                </FormGroup>
              </fieldset>
                  ...
                  <div className="col-md-10">
                    ...
                    <label className="c-radio">
                      <Input
                        ...
                        defaultChecked
                      />
                      <span className="fa fa-user"></span>b
                    </label>
                    <label className="c-radio">
                      <Input
                        id="inlineradio30"
                        ...
                        defaultChecked
                      />
                      <span className="fa fa-tint"></span>c
                    </label>
                    <br />
                    <label className="c-checkbox">
                      <Input
                        ...
                        defaultChecked
                      />
                      <span className="fa fa-star"></span>a
                    </label>
                    <label className="c-checkbox">
                      <Input
                        id="inlinecheckbox20"
                        ...
                        defaultChecked
                      />
                      <span className="fa fa-heart"></span>b
                    </label>
                    <label className="c-checkbox">
                      <Input
                        id="inlinecheckbox30"
                        ...
                        defaultChecked
                      />
                      <span className="fa fa-bell"></span>c
                    </label>
                  </div>
                </FormGroup>
              </fieldset>
