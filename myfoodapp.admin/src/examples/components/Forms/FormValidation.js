                    ...
                    <div className="form-group row align-items-center">
                      ...
                      <Col md={6}>
                        <Input
                          ...
                          name="email"
                          invalid={
                            this.hasError("formDemo", "email", "required") ||
                            this.hasError("formDemo", "email", "email")
                          }
                          onChange={this.validateOnChange}
                          data-validate='["required", "email"]'
                  ...
                  <fieldset>
                    <div className="form-group row align-items-center">
                      ...
                      <Col md={6}>
                        ...
                        />
                        <span className="invalid-feedback">
                          Field must have a valid length
                        </span>
                      </Col>
                      <Col md={4}>
                  ...
                  <fieldset>
                    <div className="form-group row align-items-center">
                      ...
                      <Col md={6}>
                        ...
                        />
                        <span className="invalid-feedback">
                          Field must have a minimun value
                        </span>
                      </Col>
                      <Col md={4}>
                  ...
                  <fieldset>
                    <div className="form-group row align-items-center">
                      ...
                      <Col md={6}>
                        ...
                        />
                        <span className="invalid-feedback">
                          Field must have a maximun value
                        </span>
                      </Col>
                      <Col md={4}>
