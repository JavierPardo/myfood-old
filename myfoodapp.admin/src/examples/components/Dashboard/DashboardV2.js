            ...
            <div className="card" id="cardChart3">
              <div className="card-header">
                <Dropdown
                  ...
                  isOpen={this.state.dropdownCardOpen}
              ...
              <div className="card-body">
                <FlotChart
                  data={this.state.barStackedData}
                  options={this.state.barStackedOptions}
                  height="250px"
                />
              </div>
            </div>
        ...
        <div className="unwrap my-3">
          ...
          <div className="card">
            <div className="card-header">
              ...
              <Dropdown
                className="float-right"
                isOpen={this.state.dropdownChartOpen}
                toggle={this.toggleDDChart}
              >
                  ...
                  <td className="wd-xs d-none d-lg-table-cell">
                    <div className="px-2">
                      <p className="m-0 text-muted">
                        <em className="icon-people mr-2 fa-lg"></em>26
                      </p>
                    </div>
                  </td>
                  <td className="wd-xs d-none d-lg-table-cell">
                    <div className="px-2">
                      <p className="m-0 text-muted">
                        <em className="icon-doc mr-2 fa-lg"></em>3500
                      </p>
                    </div>
                  </td>
                  <td className="wd-sm">
              ...
              <tbody>
                <tr>
                  ...
                  <td className="wd-xs d-none d-lg-table-cell">
                    <div className="px-2">
                      <p className="m-0 text-muted">
                        <em className="icon-people mr-2 fa-lg"></em>3
                      </p>
                    </div>
                  </td>
                  <td className="wd-xs d-none d-lg-table-cell">
                    <div className="px-2">
                      <p className="m-0 text-muted">
                        <em className="icon-doc mr-2 fa-lg"></em>150
                      </p>
                    </div>
                  </td>
                  <td className="wd-sm">
              ...
              <tbody>
                <tr>
                  ...
                  <td className="wd-xs d-none d-lg-table-cell">
                    <div className="px-2">
                      <p className="m-0 text-muted">
                        <em className="icon-people mr-2 fa-lg"></em>15
                      </p>
                    </div>
                  </td>
                  <td className="wd-xs d-none d-lg-table-cell">
                    <div className="px-2">
                      <p className="m-0 text-muted">
                        <em className="icon-doc mr-2 fa-lg"></em>480
                      </p>
                    </div>
                  </td>
                  <td className="wd-sm">
