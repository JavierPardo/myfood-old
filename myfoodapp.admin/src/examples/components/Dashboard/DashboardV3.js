      ...
      <ContentWrapper>
        <div className="content-heading">
          ...
          <div className="ml-auto">
            <Dropdown
              isOpen={this.state.dropdownTranslateOpen}
              toggle={this.toggleDDTranslate}
            >
            ...
            <div className="card card-default" id="cardChart9">
              ...
              <div className="card-body">
                <FlotChart
                  ...
                  options={this.state.splineOptions}
                  height="250px"
                />
              </div>
            </div>
                ...
                <TabPane tabId="tasks">
                  ...
                  <div className="list-group mb0">
                    <div className="list-group-item bt0">
                      ...
                      <em className="fa-fw fas fa-calendar-alt mr-2"></em>
                      Calendar updated
                    </div>
                    <div className="list-group-item">
                      ...
                      <em className="fa-fw fa fa-comment mr-2"></em>Commented on
                      a post
                    </div>
                    <div className="list-group-item">
                      <span className="badge badge-purple float-right">
                      ...
                      <em className="fa-fw fa fa-truck mr-2"></em>Order 392
                      shipped
                    </div>
                    <div className="list-group-item">
                      <span className="badge badge-purple float-right">
                      ...
                      <em className="fa-fw far fa-money-bill-alt mr-2"></em>
                    ...
                    <div className="list-group-item">
                      ...
                      <em className="fa-fw fa fa-user mr-2"></em>A new user has
                      been added
                    </div>
                    <div className="list-group-item">
                      <span className="badge badge-purple float-right">
                      ...
                      <em className="fa-fw fa fa-check mr-2"></em>Completed
                    ...
                    <div className="list-group-item">
                      ...
                      <em className="fa-fw fa fa-globe mr-2"></em>Saved the
                      world
                    </div>
                    <div className="list-group-item">
                      <span className="badge badge-purple float-right">
