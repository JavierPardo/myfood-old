...
class TableExtended extends Component {
  ...
  handleChange = (listName, index) => {
    this.setState({
      [listName]: this.state[listName].map((item, i) =>
        index !== i
          ? item
          : { ...item, checked: !this.state[listName][index].checked }
      ),
    });
  };
          ...
          <Table bordered hover responsive>
            ...
            <tbody>
                ...
                <td>
                  <div className="checkbox c-checkbox">
                    <label>
                      <input
                        type="checkbox"
                        checked={this.state.listA[0].checked}
                        onChange={(e) => this.handleChange("listA", 0)}
                      />
                      <span className="fa fa-check"></span>
                    </label>
                  </div>
              ...
              <tr>
                ...
                <td className="text-center">
                  <div
                    className="radial-bar radial-bar-50 radial-bar-xs"
                    data-label="50%"
                  ></div>
                </td>
                <td>25 minutes</td>
                <td>
                  <div className="checkbox c-checkbox">
                    <label>
                      <input
                        type="checkbox"
                        checked={this.state.listA[1].checked}
                        onChange={(e) => this.handleChange("listA", 1)}
                      />
                      <span className="fa fa-check"></span>
                    </label>
                  </div>
              ...
              <tr>
                ...
                <td className="text-center">
                  <div
                    className="radial-bar radial-bar-80 radial-bar-xs"
                    data-label="80%"
                  ></div>
                </td>
                <td>10 hours</td>
                <td>
                  <div className="checkbox c-checkbox">
                    <label>
                      <input
                        type="checkbox"
                        checked={this.state.listA[2].checked}
                        onChange={(e) => this.handleChange("listA", 2)}
                      />
                      <span className="fa fa-check"></span>
                    </label>
                  </div>
              ...
              <div>
                <div className="input-group">
                  ...
                  <div className="input-group-append">
                    <button className="btn btn-secondary" type="Search">
                      Button
                    </button>
                  </div>
                </div>
                ...
                <td>
                  <div className="checkbox c-checkbox">
                    <label>
                      <input
                        type="checkbox"
                        checked={this.state.listB[0].checked}
                        onChange={(e) => this.handleChange("listB", 0)}
                      />
                      <span className="fa fa-check"></span>
                    </label>
                  </div>
                ...
                <td>
                  <div className="media">
                    ...
                    <div className="media-body">
                      ...
                      <h4>Holly Wallace</h4>
                      <p>Username: holly123</p>Cras sit amet nibh libero, in
                      gravida nulla. Nulla vel metus scelerisque ante
                      sollicitudin commodo. Cras purus odio, vestibulum in
                      vulputate at, tempus viverra turpis. Fusce condimentum
                ...
                <td>
                  <div className="checkbox c-checkbox">
                    <label>
                      <input
                        type="checkbox"
                        checked={this.state.listB[1].checked}
                        onChange={(e) => this.handleChange("listB", 1)}
                      />
                      <span className="fa fa-check"></span>
                    </label>
                  </div>
                ...
                <td>
                  <div className="media">
                    ...
                    <div className="media-body">
                      ...
                      <h4>Alexis Foster</h4>
                      <p>Username: ali89</p>Cras sit amet nibh libero, in
                      gravida nulla. Nulla vel metus scelerisque ante
                      sollicitudin commodo. Cras purus odio, vestibulum in
                      vulputate at, tempus viverra turpis. Fusce condimentum
                      nunc ac nisi vulputate fringilla. Donec lacinia congue
                ...
                <td>
                  <div className="checkbox c-checkbox">
                    <label>
                      <input
                        type="checkbox"
                        checked={this.state.listB[2].checked}
                        onChange={(e) => this.handleChange("listB", 2)}
                      />
                      <span className="fa fa-check"></span>
                    </label>
                  </div>
                ...
                <td>
                  <div className="media">
                    ...
                    <div className="media-body">
                      ...
                      <h4>Mario Miles</h4>
                      <p>Username: mariomiles</p>Cras sit amet nibh libero, in
                      gravida nulla. Nulla vel metus scelerisque ante
                      sollicitudin commodo. Cras purus odio, vestibulum in
                      vulputate at, tempus viverra turpis. Fusce condimentum
                      nunc ac nisi vulputate fringilla. Donec lacinia congue
