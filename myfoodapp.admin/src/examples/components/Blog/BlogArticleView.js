    ...
    return (
      <ContentWrapper>
        ...
        <Alert color="info">
          ...
          <span>
            There is an autosaved version of this article that is more recent
                ...
                <div className="clearfix">
                  <div className="float-left">
                    <button type="button" className="btn btn-secondary">
                      <em className="fa fa-edit fa-fw"></em>Draft
                    </button>
                    <button type="button" className="btn btn-primary m-t-10">
                      <em className="fa fa-check fa-fw"></em>Save
                    </button>
                  </div>
                  <div className="float-right">
                    <button type="button" className="btn btn-danger">
                      <em className="fas fa-trash-alt fa-fw"></em>Remove
                    </button>
                  </div>
                </div>
              </form>
              ...
              <Table responsive hover>
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td>
                      Quisque enim nisi, semper non pulvinar et, aliquam id
                      lorem...
                    </td>
                    <td className="text-center">
