      ...
      <ContentWrapper>
          ...
          <div className="col-xl-4">
            ...
            <div className="card">
              <div className="card-body">
                ...
                <div className="progress progress-xs mb-3">
                  <div
                    className="progress-bar progress-bar-striped bg-green"
                    role="progressbar"
                    aria-valuenow="80"
                    aria-valuemin="0"
                    aria-valuemax="100"
          ...
          <div className="col-xl-4">
            ...
            <div className="card">
              ...
              <div className="card-body text-center">
                ...
                <p>
                  Proin metus justo, commodo in ultrices at, lobortis sit amet
                  dui. Fusce dolor purus, adipiscing a tempus at, gravida vel
                  purus.
                </p>
              </div>
            ...
            <div className="card">
              ...
              >
                <div className="row">
                  <div className="col-12 text-white">
                    ...
                    <p className="m-0">
                      <em className="fab fa-twitter fa-fw"></em>@chris
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="list-group">
                <a className="list-group-item" href="">
                  ...
                  <em className="fa-fw far fa-clock text-muted"></em>Recent
                  Activity
                </a>
                <a className="list-group-item" href="">
                  <span className="badge badge-primary float-right">100</span>
                  <em className="fa-fw fa fa-user text-muted"></em>Following
                </a>
                <a className="list-group-item" href="">
                  <span className="badge badge-primary float-right">300</span>
                  <em className="fa-fw far fa-folder-open text-muted"></em>
                  Photos
                </a>
              </div>
            </div>
              ...
              <div className="row row-flush">
                ...
                <div className="col-7">
                  <div className="p-3">
                    ...
                    <p>
                      <span className="text-lg">16</span>Aug
                    </p>
                    <p>
                      <strong>EVENT INVITATION</strong>
                    </p>
                    <p>
                      Donec posuere neque in elit luctus tempor consequat enim
                      egestas. Nulla dictum egestas leo at lobortis.
                    </p>
                  </div>
                </div>
              </div>
          ...
          <div className="col-xl-4">
            ...
            <div className="card">
              <div className="card-body bg-danger text-center">
                ...
                <img
                  className="img-thumbnail circle thumb96"
                  src="img/user/06.jpg"
                  alt="Demo"
                />
                <h4 className="mt-0">Lois Berry</h4>
                <p className="m-0">
                  <em className="fa-fw fas fa-map-marker-alt"></em>San
        ...
        <div className="row">
          <div className="col-xl-4">
            ...
            <div className="card">
              <img
                className="img-fluid ie-fix-flex"
                src="img/bg1.jpg"
                alt="Demo"
              />
              <div className="card-body">
                ...
                <div className="row">
                  ...
                  <div className="col-6">
                    ...
                    <ul className="list-unstyled mb-0">
                      <li className="mb-1">
                        <em className="fas fa-map-marker-alt fa-fw"></em>ASD,
                        Qwerty
                      </li>
                      <li className="mb-1">
                        <em className="fab fa-twitter fa-fw"></em>@asdasd
                      </li>
                      <li className="mb-1">
                        <em className="fa fa-envelope fa-fw"></em>
                        asdasd@mail.com
                      </li>
                    </ul>
                  </div>
              ...
              <div className="card-body">
                <div className="row align-items-center">
                  <div className="col-5 text-center">
                    <img
                      className="img-thumbnail circle img-fluid thumb96"
                      src="img/user/06.jpg"
                      alt="Demo"
                    />
                  </div>
            ...
            <div className="card">
              <div className="card-body">
                <div className="d-flex align-items-center">
                  <div className="text-center">
                    <img
                      className="img-thumbnail circle img-fluid thumb64"
                      src="img/user/06.jpg"
                      alt="Demo"
                    />
                  </div>
        ...
        <div className="card card-transparent">
          <Nav tabs justified>
            ...
            <NavItem>
              <NavLink
                className={this.state.activeTab === "trans" ? "active" : ""}
                onClick={() => {
                  this.toggleTab("trans");
                }}
              >
                <em className="far fa-money-bill-alt fa-fw"></em>Transactions
                card
              </NavLink>
            </NavItem>
          </Nav>
            ...
            <TabPane tabId="tasks">
              ...
              <div className="list-group mb0">
                <div className="list-group-item bt0">
                  <span className="badge badge-purple float-right">
                    just now
                  </span>
                  <em className="fa-fw fas fa-calendar-alt mr-2"></em>Calendar
                  updated
                </div>
                <div className="list-group-item">
                  ...
                  <em className="fa-fw fa fa-comment mr-2"></em>Commented on a
                  post
                </div>
                <div className="list-group-item">
                  <span className="badge badge-purple float-right">
                ...
                <div className="list-group-item">
                  ...
                  <em className="fa-fw far fa-money-bill-alt mr-2"></em>Invoice
                  653 has been paid
                </div>
                <div className="list-group-item">
                  <span className="badge badge-purple float-right">
                  ...
                  <em className="fa-fw fa fa-user mr-2"></em>A new user has been
                  added
                </div>
                <div className="list-group-item">
                  <span className="badge badge-purple float-right">
                  ...
                  <em className="fa-fw fa fa-check mr-2"></em>Completed task:
