          ...
          <Row>
            <Col md={4}>
              <CardDefault>
                ...
                <CardBody>
                  <ChartistGraph
                    data={BarBipolar.data}
                    options={BarBipolar.options}
                    type={"Bar"}
                  />
                </CardBody>
              </CardDefault>
            ...
            <Col md={4}>
              <CardDefault>
                ...
                <CardBody>
                  <ChartistGraph
                    data={BarHorizontal.data}
                    options={BarHorizontal.options}
                    type={"Bar"}
                  />
                </CardBody>
              </CardDefault>
          ...
          <Row>
            <Col md={6}>
              <CardDefault>
                ...
                <CardBody>
                  <ChartistGraph
                    data={SlimAnimation.data}
                    options={SlimAnimation.options}
                    listener={SlimAnimation.events}
                    type={"Line"}
                  />
                </CardBody>
              </CardDefault>
            ...
            <Col md={6}>
              <CardDefault>
                ...
                <CardBody>
                  <ChartistGraph
                    data={SVGAnimation.data}
                    options={SVGAnimation.options}
                    listener={SVGAnimation.events}
                    type={"Line"}
                  />
                </CardBody>
              </CardDefault>
