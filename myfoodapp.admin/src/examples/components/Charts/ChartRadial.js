      ...
      <ContentWrapper>
        <div className="content-heading">
          <div>
            Radial charts
            <small>
              Canvas based &amp; No canvas Pure CSS radial progress bars
              solutions
            </small>
          </div>
        </div>
              ...
              <CardBody>
                <Row>
                  <Col md={3}>
                    <div
                      data-label="85%"
                      className="radial-bar radial-bar-85 radial-bar-lg"
                    ></div>
                  </Col>
                  <Col md={3}>
                    <div
                      data-label="45%"
                      className="radial-bar radial-bar-45"
                    ></div>
                  </Col>
                  <Col md={3}>
                    <div
                      data-label="60%"
                      className="radial-bar radial-bar-60 radial-bar-sm"
                    ></div>
                  </Col>
                  <Col md={3}>
                    <div
                      data-label="20%"
                      className="radial-bar radial-bar-20 radial-bar-xs"
                    ></div>
                  </Col>
                </Row>
              </CardBody>
              ...
              <CardBody>
                <Row>
                  ...
                  <Col md={3}>
                    <div
                      data-label="35%"
                      className="radial-bar radial-bar-35 radial-bar-warning"
                    >
                  ...
                  <Col md={3}>
                    <div
                      data-label="50%"
                      className="radial-bar radial-bar-50 radial-bar-info"
                    >
                  ...
                  <Col md={3}>
                    <div
                      data-label="100%"
                      className="radial-bar radial-bar-100 radial-bar-success"
                    >
                ...
                <Row>
                  <Col md={3}>
                    ...
                    <div
                      data-label="85%"
                      data-title="85%"
                      className="radial-bar radial-bar-85"
                    ></div>
                  </Col>
                  <Col md={3}>
                    <br />
                  ...
                  <Col md={3}>
                    ...
                    <div
                      data-label="60%"
                      data-title="60%"
                      className="radial-bar radial-bar-60"
                    ></div>
                  </Col>
                  <Col md={3}>
                    <br />
                    <div
                      data-label="20%"
                      data-title="20%"
                      className="radial-bar radial-bar-20"
                    ></div>
                  </Col>
                </Row>
              </CardBody>
              ...
              <CardBody>
                <Row>
                  <Col md={3}>
                    <div
                      data-label="20%"
                      className="radial-bar radial-bar-20 radial-bar-lg radial-bar-danger"
                    ></div>
                  </Col>
                  <Col md={3}>
                    <div
                      data-label="35%"
                      className="radial-bar radial-bar-35 radial-bar-lg radial-bar-warning"
                    ></div>
                  </Col>
                  <Col md={3}>
                    <div
                      data-label="50%"
                      className="radial-bar radial-bar-50 radial-bar-lg radial-bar-info"
                    ></div>
                  </Col>
                  <Col md={3}>
                    <div
                      data-label="100%"
                      className="radial-bar radial-bar-100 radial-bar-lg radial-bar-success"
                    ></div>
                  </Col>
                </Row>
              </CardBody>
              ...
              <CardFooter className="text-center">
                <Row>
                  <Col md={4}>
                    <div
                      data-label="35%"
                      className="radial-bar radial-bar-warning radial-bar-35 radial-bar-sm"
                    ></div>
                    <p>
                  ...
                  <Col md={4}>
                    <div
                      data-label="45%"
                      className="radial-bar radial-bar-info radial-bar-45 radial-bar-sm"
                    ></div>
                    <p>
                  ...
                  <Col md={4}>
                    <div
                      data-label="20%"
                      className="radial-bar radial-bar-success radial-bar-20 radial-bar-sm"
                    ></div>
                    <p>
                      <small>Uniques</small>
                    </p>
