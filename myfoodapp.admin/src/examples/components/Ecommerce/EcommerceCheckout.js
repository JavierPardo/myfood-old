                          ...
                          <div className="c-radio">
                            <label>
                              <input
                                id="chk-guest"
                                type="radio"
                                name="checkout-ship-to"
                                defaultValue="address"
                              />
                              <span className="fa fa-check"></span>Ship to this
                              address
                            </label>
                          </div>
                          <div className="c-radio">
                            <label>
                              <input
                                ...
                                defaultValue="other"
                              />
                              <span className="fa fa-check"></span>Ship to
                              different address
                            </label>
                          </div>
                        </div>
                        ...
                        <div className="my-2">
                          <div className="checkbox c-checkbox">
                            <label>
                              ...
                              />
                              <span className="fa fa-check"></span>Use Billing
                              Address
                            </label>
                          </div>
                        </div>
                        ...
                        <Row>
                          <Col xl="6">
                              ...
                              <div className="c-radio">
                                <label>
                                  <input
                                    ...
                                    defaultChecked
                                  />
                                  <span className="fa fa-check"></span>Paypal
                                </label>
                              </div>
                            </div>
                            <div className="form-group">
                              <div className="c-radio">
                                <label>
                                  <input
                                    ...
                                    defaultValue="check"
                                  />
                                  <span className="fa fa-check"></span>Check /
                                  Money order
                                </label>
                              </div>
                            </div>
                            <div className="form-group">
                              <div className="c-radio">
                                <label>
                                  ...
                                  />
                                  <span className="fa fa-check"></span>Credit
                                  Card (saved)
                                </label>
                              </div>
                            </div>
                            ...
                            <div className="form-group">
                              ...
                              <select
                                className="form-control"
                                name="checkout-cc-type"
                                required
                              >
                                <option defaultValue="">
                                  - Please Select -
                                </option>
                                <option defaultValue="amex">
                                  American Express
                                </option>
