            ...
            <tbody>
              <tr>
                <td>
                  ...
                  <div className="text-muted text-sm">
                    <span>
                      <strong className="mr-1">17</strong>views
                    </span>
                    <span className="mx-1"></span>
                    <span>
                      <strong className="mr-1">19</strong>comments
                    </span>
                  </div>
                </td>
              ...
              <tr>
                <td>
                  ...
                  <div className="text-muted text-sm">
                    <span>
                      <strong className="mr-1">7</strong>views
                    </span>
                    <span className="mx-1"></span>
                    <span>
                      <strong className="mr-1">13</strong>comments
                    </span>
                  </div>
                </td>
                <td className="text-right d-none d-lg-table-cell">
              ...
              <tr>
                <td>
                  ...
                  <div className="text-muted text-sm">
                    <span>
                      <strong className="mr-1">13</strong>views
                    </span>
                    <span className="mx-1"></span>
                    <span>
                      <strong className="mr-1">500</strong>comments
                    </span>
                  </div>
                </td>
                <td className="text-right d-none d-lg-table-cell">
              ...
              <tr>
                <td>
                  ...
                  <div className="text-muted text-sm">
                    <span>
                      <strong className="mr-1">98</strong>views
                    </span>
                    <span className="mx-1"></span>
                    <span>
                      <strong className="mr-1">1900</strong>comments
                    </span>
                  </div>
                </td>
                <td className="text-right d-none d-lg-table-cell">
              ...
              <tr>
                <td>
                  ...
                  <div className="text-muted text-sm">
                    <span>
                      <strong className="mr-1">31</strong>view
                    </span>
                    <span className="mx-1"></span>
                    <span>
                      <strong className="mr-1">190</strong>comments
                    </span>
                  </div>
                </td>
                <td className="text-right d-none d-lg-table-cell">
              ...
              <tr>
                <td>
                  ...
                  <div className="text-muted text-sm">
                    <span>
                      <strong className="mr-1">27</strong>views
                    </span>
                    <span className="mx-1"></span>
                    <span>
                      <strong className="mr-1">419</strong>comments
                    </span>
                  </div>
                </td>
                <td className="text-right d-none d-lg-table-cell">
