    ...
    return (
      <span>
        ...
        >
          ...
          <PopoverBody>
            Proin posuere gravida ipsum, a pretium augue commodo eget. Fusce
            pellentesque congue justo.
          </PopoverBody>
        </Popover>
      </span>
    );
    ...
    return (
      <ContentWrapper>
        <div className="content-heading">
          <div>
            Notifications
            <span className="text-sm d-none d-sm-block">
                      ...
                      <FormGroup check key={i}>
                        <Label check>
                          <Input
                            ...
                            name="tPosition"
                            value={pos}
                            checked={this.state.toasterPos === pos}
                            onChange={this.onToastPosChanged}
                          />{" "}
                          {pos}
                        </Label>
                      </FormGroup>
                      ...
                      <FormGroup check key={i}>
                        <Label check>
                          <Input
                            ...
                            name="tType"
                            value={type}
                            checked={this.state.toasterType === type}
                            onChange={this.onToastTypeChanged}
                          />{" "}
                          {type}
                        </Label>
                      </FormGroup>
