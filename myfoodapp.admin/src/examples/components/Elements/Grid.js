        ...
        <Container fluid className="grid-example">
          ...
          <div className="card mb-3">
            ...
            <div className="card-body">
              ...
              <p className="my-4 text-bold" id="setting-one-column-width">
              ...
              <p className="my-4 text-bold" id="variable-width-content">
              ...
              <p className="my-4 text-bold" id="equal-width-multi-row">
          ...
          <div className="card mb-3">
            ...
            <div className="card-body">
              <p className="my-4 text-bold" id="all-breakpoints">
                All breakpoints
              </p>
              <Row>
                <div className="col">col</div>
              ...
              <p className="my-4 text-bold" id="stacked-to-horizontal">
              ...
              <p className="my-4 text-bold" id="mix-and-match">
                Mix and match
              </p>
          ...
          <div className="card mb-3">
            ...
            <div className="card-body">
              <p className="my-4 text-bold" id="vertical-alignment">
                Vertical alignment
              </p>
              <div className="container">
              ...
              <p className="my-4 text-bold" id="horizontal-alignment">
              ...
              <p className="my-4 text-bold" id="no-gutters">
                No gutters
              </p>
              ...
              <p className="my-4 text-bold" id="column-wrapping">
                Column wrapping
              </p>
              <Row>
              ...
              <p className="my-4 text-bold" id="column-resets">
                Column resets
              </p>
              <Row>
              ...
              <Row>
                ...
                <div className="col-md-5 offset-sm-2 col-xl-6 offset-md-0">
                  .col-md-5 .offset-sm-2 .col-xl-6 .offset-md-0
                </div>
              </Row>
              <Row>
                <div className="col-md-6 col-xl-5 col-xl-6">
                  .col.col-md-6.col-xl-5.col-xl-6
                </div>
                <div className="col-md-6 col-xl-5 offset-md-2 col-xl-6 offset-lg-0">
          ...
          <div className="card mb-3">
            ...
            <div className="card-body">
              <p className="my-4 text-bold" id="flex-order">
                Flex order
              </p>
              <p className="my-4 text-bold" id="offsetting-columns">
                Offsetting columns
              </p>
              <Row>
                <div className="col-xl-4">.col-xl-4</div>
                <div className="col-xl-4 offset-md-4">
                  .col-xl-4 .offset-md-4
                </div>
              </Row>
              <Row>
                <div className="col-xl-3 offset-md-3">
