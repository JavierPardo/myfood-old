          ...
          <Row>
              ...
              <Card className="card-default">
                <CardHeader>
                  ...
                  <CardTool
                    dismiss
                    refresh
                    onRemove={this.onCardRemove}
                    onRemoved={this.onCardRemoved}
                    onRefresh={this.onCardRefresh}
                  />
                </CardHeader>
                <CardBody>
                  <p>
                    Card can be dismissed by clicking on the cross icon icon on
            ...
            <Col lg={4}>
              ...
              <Card className="card-default">
                ...
                <CardBody>
                  <p>
                    Click on the refresh icon to see how it triggers a
                    refresh-event while it shows a spinner
                  </p>
                </CardBody>
              </Card>
              {/* END card */}
              ...
              <CardBody>
                <div role="tabpanel">
                  ...
                  <TabContent activeTab={this.state.activeTab}>
                    ...
                    <TabPane tabId="2">
                      Integer lobortis commodo auctor.
                    </TabPane>
                    <TabPane tabId="3">
                      Lorem ipsum dolor sit amet, consectetur adipiscing elit.
                    </TabPane>
                    <TabPane tabId="4">
                      Sed commodo tellus ut mi tristique pharetra.
                    </TabPane>
                  </TabContent>
                </div>
              </CardBody>
