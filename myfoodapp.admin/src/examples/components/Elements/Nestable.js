      ...
      <ContentWrapper>
        ...
        <Container fluid>
          <div className="js-nestable-action">
            ...
            <a data-action="collapse-all" className="btn btn-default btn-sm">
              CollapseAll
            </a>
          </div>
          <Row>
          ...
          <br />
          <p>
            (*) Note that in a React enviroment, 'serialize' api from Nestable
            plugin will read also the 'data-react-id' attribute
          </p>
        </Container>
      </ContentWrapper>
    );
