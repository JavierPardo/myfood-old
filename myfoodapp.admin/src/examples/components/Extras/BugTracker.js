                  ...
                  <table className="table w-100">
                    ...
                    <tbody>
                      <tr>
                        ...
                        <td>
                          <div className="inline wd-xxs badge badge-success">
                            open
                          </div>
                        </td>
                      </tr>
                      <tr>
                        ...
                        <td className="text-nowrap">
                          <small>
                            Aliquam felis nibh, ultrices non elementum
                          </small>
                        </td>
                        <td>01/05/2016</td>
                        <td>
                      ...
                      <tr>
                        ...
                        <td>
                          <div className="inline wd-xxs badge badge-danger">
                            closed
                          </div>
                        </td>
                      </tr>
