      ...
      <ContentWrapper>
        <div className="content-heading">
          <div>
            ...
            <small>
              In lacinia tellus vitae nisl consectetur pellentesque.
            </small>
          </div>
        </div>
        <Row>
          <Col xl="8">
            ...
            <div className="card b">
              ...
              <div className="card-body">
                <h4>Description</h4>
                <p>
                  Nam eget risus tellus. Vestibulum pretium mollis ligula, at
                  ultrices quam egestas et. Sed mattis tincidunt ligula, ac
                  porttitor lectus porttitor condimentum. Ut et ligula ante, nec
                  mollis lacus. Aliquam erat volutpat. Aliquam auctor diam ut
                  urna lacinia faucibus. Proin est sapien, convallis non
                  hendrerit nec, laoreet ut ipsum. Aenean vehicula, nulla vel
                  pharetra accumsan, elit risus pretium arcu, nec ultrices urna
                  ligula vel nunc. Cras porttitor orci eget nibh pharetra
                  mollis.
                </p>
                <p>
                  Maecenas at porta purus. Ut eu aliquam orci. Praesent in
                  libero at neque gravida venenatis auctor nec arcu.
                </p>
              ...
              <div className="card-body bb">
                <div className="clearfix">
                  ...
                  <div className="float-right">
                    <button className="btn btn-danger btn-oval" type="button">
                      Cancel
                    </button>
                  </div>
                </div>
