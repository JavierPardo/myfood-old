          ...
          <Col lg="4">
            <div className="card card-default">
              <div className="card-body text-center">
                ...
                <div className="my-3">
                  <p>
                    Hello, I'm a just a dummy contact in your contact list and
                    this is my presentation text. Have fun!
                  </p>
                </div>
                      ...
                      <div className="form-group row">
                        ...
                        <div className="col-xl-10 col-md-9 col-8">
                          <input
                            ...
                            id="inputContact5"
                            type="text"
                            defaultValue="http://some.wesbite.com"
                          />
                        </div>
                      </div>
                      <div className="form-group row">
                        ...
                        <div className="col-xl-10 col-md-9 col-8">
                          <textarea
                            ...
                            id="inputContact6"
                            row="4"
                            defaultValue="Some nice Street, 1234"
                          ></textarea>
                        </div>
                      </div>
                      <div className="form-group row">
