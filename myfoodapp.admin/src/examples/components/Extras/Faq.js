            ...
            <Col lg="4">
              <Card>
                <CardBody className="text-center">
                  <p className="mb-3">
                    Sed semper diam vitae purus tristique at scelerisque massa
                    ultricies.
                  </p>
          ...
          <div>
            <Card className="b0 mb-2">
              ...
              <Collapse isOpen={this.state.accordionState[0]}>
                <CardBody>
                  <p>
                    Donec congue sagittis mi sit amet tincidunt. Quisque
                    sollicitudin massa vel erat tincidunt blandit. Curabitur
                    quis leo nulla. Phasellus faucibus placerat luctus. Integer
                    fermentum molestie massa at congue. Quisque quis quam dictum
                    diam volutpat adipiscing.
                  </p>
