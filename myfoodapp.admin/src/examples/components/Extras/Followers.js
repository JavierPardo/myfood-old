  ...
  <Card className="b text-center">
    ...
    <CardBody>
      ...
      {props.user ? (
        ...
        <button className="btn btn-info btn-oval" type="button">
          Following
        </button>
      ) : (
        <button className="btn btn-success btn-oval" type="button">
          Follow
        </button>
      )}
    </CardBody>
        ...
        <Row>
          ...
          <Col xl="3" lg="4">
            ...
            <Card className="b">
              ...
              <CardBody>
                <div className="media align-items-center">
                  <a className="mr-2" href="">
                    <img
                      className="rounded-circle img-thumbnail thumb48"
                      src="img/user/04.jpg"
                      alt="Contact"
                    />
                  </a>
              ...
              <CardBody>
                <a className="link-unstyled text-muted" href="">
                  Find more friends
                </a>
              </CardBody>
            </Card>
