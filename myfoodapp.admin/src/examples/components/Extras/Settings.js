          ...
          <Row>
            <Col lg="3">
              <div className="card b">
                <div className="card-header bg-gray-lighter text-bold">
                  Personal Settings
                </div>
                <ListGroup>
                  <ListGroupItem
                  ...
                  <ListGroupItem
                    action
                    className={
                      this.state.activeTab === "account" ? "active" : ""
                    }
                    onClick={() => {
                  ...
                  <ListGroupItem
                    action
                    className={
                      this.state.activeTab === "emails" ? "active" : ""
                    }
                    onClick={() => {
                      this.toggleTab("emails");
                    }}
                  >
                    Emails
                  </ListGroupItem>
                  <ListGroupItem
                    action
                    className={
                      this.state.activeTab === "notifications" ? "active" : ""
                    }
                    onClick={() => {
                      this.toggleTab("notifications");
                    }}
                  >
                    Notifications
                  </ListGroupItem>
                  <ListGroupItem
                    action
                    className={
                      this.state.activeTab === "applications" ? "active" : ""
                    }
                    onClick={() => {
                      this.toggleTab("applications");
                    }}
                  >
                    Applications
                  </ListGroupItem>
            ...
            <Col lg="9">
              <TabContent activeTab={this.state.activeTab} className="p-0 b0">
                ...
                <TabPane tabId="account">
                  ...
                  <div className="card b">
                    <div className="card-header bg-danger text-bold">
                      Delete account
                    </div>
                    <div className="card-body bt">
                      <p>
                        You will be asked for confirmation before delete
                        account.
                      </p>
                ...
                <TabPane tabId="emails">
                  <div className="card b">
                    ...
                    <div className="card-body">
                      <p>
                        Etiam eros nibh, condimentum in auctor et, aliquam quis
                        elit. Donec id libero eros. Ut fringilla, justo id
                        fringilla pretium, nibh nunc suscipit mauris, et
                        suscipit nulla nisl ac dolor. Nam egestas, leo eu
                        gravida tincidunt, sem ipsum pellentesque quam, vel
                        iaculis est quam et eros.
                      </p>
                      <p>
                  ...
                  <form action="">
                    <div className="card b">
                      ...
                      <div className="card-body">
                        ...
                        <button className="mb-3 btn btn-info" type="button">
                          Update notifications
                        </button>
                        <p>
                          <small className="text-muted">
                            Mauris sodales accumsan erat, ut dapibus erat
                            faucibus vitae.
                          </small>
                        </p>
                      </div>
                      ...
                      <ListGroup>
                        <ListGroupItem className="d-flex align-items-center">
                          ...
                          <div>
                            ...
                            <small>
                              Ut turpis urna, tristique sed adipiscing nec,
                              luctus quis leo.
                            </small>
                          </div>
