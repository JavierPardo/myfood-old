                  ...
                  <div className="timeline-card">
                    <div className="popover left">
                      ...
                      <div className="popover-body">
                        ...
                        <p>
                          <em>
                            "Fusce pellentesque congue justo in rutrum. Praesent
                            non nulla et ligula luctus mattis eget at lacus."
                          </em>
                        </p>
                      </div>
                    </div>
                  ...
                  <div className="timeline-card">
                    <div className="popover left">
                      ...
                      <div className="popover-body">
                        ...
                        <p>
                          <em>
                            "Hey guys! Please check the new location for
                            tomorrows's meeting."
                          </em>
                        </p>
                        <DemoMapCustomStyle
            ...
            <Col xl="3">
              <div className="card card-default">
                <div className="card-body">
                  ...
                  <ul className="list-unstyled px-4">
                    <li>
                      <em className="fa fa-home fa-fw mr-3"></em>Somewhere,
                      Neverland
                    </li>
                    <li>
              ...
              <div className="card card-default">
                ...
                <ListGroup>
                  ...
                  <ListGroupItem
                    action
                    className="media p-2 mt-0 text-center text-muted"
                  >
                    View all contacts
                  </ListGroupItem>
                </ListGroup>
