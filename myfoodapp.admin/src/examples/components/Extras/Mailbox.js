        ...
        <div className="row">
          <div className="col-xl-3 col-lg-4">
            <div className="d-flex mb-2">
              ...
              <button
                className="btn btn-sm btn-secondary mb-toggle-button ml-auto"
                type="button"
                  ...
                  <tbody>
                        ...
                        <div className="d-flex">
                          ...
                          <div className="mb-mail-meta">
                            ...
                            <div className="mb-mail-preview">
                              Fusce gravida, diam ac adipiscing pretium, sem
                              nibh bibendum diam, non consequat quam metus non
                              nunc
                            </div>
                          </div>
                    ...
                    <tr>
                      ...
                      <td>
                        <div className="d-flex">
                          <img
                            className="mr-2 mb-mail-avatar"
                            alt="Mail Avatar"
                            src="img/user/02.jpg"
                          />
                          <div className="mb-mail-meta">
                            <div className="mb-mail-subject">
                              Admin theme based on Bootstrap and AngularJS
                            </div>
                            <div className="mb-mail-from">Allison Grant</div>
                            <div className="mb-mail-preview">
                              Nunc eget lacinia felis. Pellentesque sollicitudin
                              sollicitudin erat, in imperdiet tortor fringil
                            </div>
                          </div>
                    ...
                    <tr>
                      ...
                      <td>
                        <div className="d-flex">
                          ...
                          <div className="mb-mail-meta">
                            <div className="mb-mail-subject">
                              Nested route mailbox application
                            </div>
                            <div className="mb-mail-from">Daryl Carlson</div>
                            <div className="mb-mail-preview">
                              Nulla facilisi. Sed sit amet sem vel purus
                              pulvinar venenatis. Class aptent taciti
                            </div>
                          </div>
                    ...
                    <tr>
                      ...
                      <td>
                        <div className="d-flex">
                          ...
                          <div className="mb-mail-meta">
                            <div className="mb-mail-subject">
                              Angular with lazy load components
                            </div>
                            <div className="mb-mail-from">George Clark</div>
                            <div className="mb-mail-preview">
                              Integer sit amet vulputate mauris. Proin purus
                              nisl, tempor ut tempor at, ornare vel mauris. Ut
                              ac l
                            </div>
                          </div>
                    ...
                    <tr>
                      ...
                      <td>
                        <div className="d-flex">
                          ...
                          <div className="mb-mail-meta">
                            <div className="mb-mail-subject">
                              Don&apos;t forget to check latest updates!
                            </div>
                            <div className="mb-mail-from">Warren Watts</div>
                            <div className="mb-mail-preview">
                              Vestibulum ante ipsum primis in faucibus orci
                              luctus et ultrices posuere cubilia Curae; In at
                              conseq
                            </div>
                          </div>
                      ...
                      <td>
                        <div className="d-flex">
                          ...
                          <div className="mb-mail-meta">
                            ...
                            <div className="mb-mail-preview">
                              Nunc hendrerit, neque ullamcorper eleifend ornare,
                              arcu est bibendum ipsum, id malesuada sem justo v
                            </div>
                          </div>
                    ...
                    <tr>
                      ...
                      <td>
                        <div className="d-flex">
                          ...
                          <div className="mb-mail-meta">
                            <div className="mb-mail-subject">
                              Issue #5478 awaiting reply
                            </div>
                            <div className="mb-mail-from">Rose Fox</div>
                            <div className="mb-mail-preview">
                              Sed eu felis nulla. Nunc malesuada sapien at risus
                              eleifend ut lacinia sem pretium.
                            </div>
                          </div>
                    ...
                    <tr>
                      ...
                      <td>
                        <div className="d-flex">
                          ...
                          <div className="mb-mail-meta">
                            <div className="mb-mail-subject">
                              Check Angle for your next startup project
                            </div>
                            <div className="mb-mail-from">Jenny Knight</div>
                            <div className="mb-mail-preview">
                              Morbi varius sem quis purus suscipit tempus.
                              Integer fermentum accumsan metus, id sagittis
                              ipsum mol
                            </div>
                          </div>
