      ...
      <ContentWrapper>
        <Container className="container-md py-4">
          <div className="text-center mb-3 pb-3">
            ...
            <p>
              Select the plan in different options that best fit your project
            </p>
          </div>
        </Container>
        <Container className="container-md">
            ...
            <Col lg="4">
              <div className="plan">
                ...
                <ul className="plan-features">
                  <li>
                    <em className="fa fa-check"></em>Unlimited Styles
                  </li>
                  <li>
                    <em className="fa fa-check"></em>RTL &amp; Translation
                  </li>
                  <li>
                    <em className="fa fa-check"></em>Customer support
                  </li>
                  <li>
                    <em className="fa fa-check"></em>Free Updates
                  </li>
                  <li>
                    <em className="fa fa-check"></em>Limited to one client
                  </li>
                  <li>
                    <em className="fa fa-times plan-feature-disable"></em>
                    Multiple installation
                  </li>
                  <li>
                    <em className="fa fa-times plan-feature-disable"></em>Not
                    ready for resale
                  </li>
                </ul>
                <hr />
            ...
            <Col lg="4">
              <div className="plan">
                ...
                <ul className="plan-features">
                  ...
                  <li>
                    <em className="fa fa-check"></em>Unlimited clients
                  </li>
                  <li>
                    <em className="fa fa-check"></em>Multiple installation
                  </li>
                  <li>
                    <em className="fa fa-times plan-feature-disable"></em>Not
                    ready for resale
                ...
                <p className="plan-description">
                  The perfect price for all your project solutions.
                </p>
                <div className="text-center">
                  <a className="btn btn-info" href="">
                    Choose
            ...
            <Col lg="4">
              <div className="plan">
                ...
                <ul className="plan-features">
                  ...
                  <li>
                    <em className="fa fa-check"></em>Ready for resale
                  </li>
                </ul>
                <hr />
                <div className="text-center">
              ...
              <p className="text-center text-muted">
                <small>
                  * Subject to specific license terms. Price and features listed
                  for demo only.
                </small>
              </p>
            </Col>
          ...
          <p className="text-center text-muted">
            <small>
              * Subject to specific license terms. Price and features listed for
              demo only.
            </small>
          </p>
        </Container>
