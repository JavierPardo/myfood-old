  ...
  render = () => (
    <ContentWrapper>
      <div className="card b text-white">
        <div
          className="card-body bg-cover clearfix"
        ...
        <div className="card b">
          <div className="card-header">
            ...
            <div className="media mt-0">
              <img
                className="mr-2 img-thumbnail rounded-circle thumb32"
                src="img/user/03.jpg"
                alt="Demo"
              />
              <div className="media-body">
          ...
          <div className="card-body">
            <div className="row">
              ...
              <div className="col-xl-8">
                <h4>Lorem Ipsum</h4>
                <p>
                  Fusce at enim eget nibh convallis elementum. Duis a neque
                  odio, at varius elit. Suspendisse ullamcorper eros eget augue
                  ultrices feugiat. Phasellus dictum nisi eu ipsum fermentum
                  rhoncus. Mauris eu lacus massa, vel condimentum lectus..
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="card-body">
            <blockquote>
              <p>
                ...
                eu odio vitae augue elementum molestie sed quis turpis.
              </p>
              <footer>
                Someone famous in
      ...
      <div className="text-center my-3">
        <button className="btn btn-secondary btn-oval btn-lg" type="button">
          Load more..
        </button>
      </div>
    </ContentWrapper>
